...
update_taxonomy <- function(aligned_data,
  ...
  ## split tibble of aligned names based on the taxonomic dataset (APC, APNI) 
  ## and the taxon rank (family, genus, species/infraspecific) assigned during taxon alignments   
  taxa_out <-
    aligned_data %>%
      mutate(
