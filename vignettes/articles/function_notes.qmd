...
**description**: This function processes the geographic data available in the APC and returns state level diversity for native, introduced and more complicated species origins.
