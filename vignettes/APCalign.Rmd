...
#> 1 Tetratheca ci… <NA>                 SPECIES               145.           -37.4 Tetratheca ci…
#> 2 Peganum harma… <NA>                 SPECIES               139.           -33.3 Peganum harma…
#> 3 Calotis multi… <NA>                 SPECIES               115.           -24.3 Calotis multi…
#> 4 Leptospermum … <NA>                 SPECIES               151.           -34.0 Leptospermum …
#> 5 Lepidosperma … <NA>                 SPECIES               142.           -37.3 Lepidosperma …
#> 6 Enneapogon po… <NA>                 SPECIES               129.           -17.8 Enneapogon po…
#> # ℹ 123 more rows
...
#> Time difference of 23.361 secs
```
...
#> 1 Tetratheca cili… Tetratheca … Tetratheca c… Tetratheca ci… Tetr… species    APC              
#> 2 Peganum harmala  Peganum har… Peganum harm… Peganum harma… Pega… species    APC              
#> 3 Calotis multica… Calotis mul… Calotis mult… Calotis multi… Calo… species    APC              
#> 4 Leptospermum tr… Leptospermu… Leptospermum… Leptospermum … Lept… species    APC              
#> 5 Lepidosperma la… Lepidosperm… Lepidosperma… Lepidosperma … Lepi… species    APC              
#> 6 Enneapogon poly… Enneapogon … Enneapogon p… Enneapogon po… Enne… species    APC              
#> # ℹ 123 more rows
...
#>   <chr>              <chr>                                
#> 1 Glyceria australis considered native to Australia by APC
```
...
#> 4 Leptospermum trinervium Leptospermu… Leptospermu… APC               species    Exact match o…
#> 5 Lepidosperma laterale   Lepidosperm… Lepidosperm… APC               species    Exact match o…
#> 6 Enneapogon polyphyllus  Enneapogon … Enneapogon … APC               species    Exact match o…
#> # ℹ 123 more rows
...
#>   <chr>                                                             <int>   <dbl>         <dbl>
#> 1 Exact match of taxon name to an APC-accepted canonical name once…   118 0.915         0.929  
#> 2 Exact match of taxon name to an APC-known canonical name once pu…     6 0.0465        0.0472 
#> 3 Exact match of taxon name to an APNI-listed canonical name once …     1 0.00775       0.00787
#> 4 Exact match of the first two words of the taxon name to an APC-a…     1 0.00775       0.00787
#> 5 Exact match of the first word of the taxon name to an APC-accept…     1 0.00775       0.00787
#> 6 <NA>                                                                  2 0.0155       NA
```
...
- `identifier` allows you to specify a text string that is added to genus-level matches, indicating the site, study, etc e.g. `Acacia sp. [long leaves]`
...
#>   <chr>                   <chr>            <chr>         <chr>          <chr> <chr>  <chr>     
#> 1 Tetratheca ciliata      Tetratheca cili… Tetratheca c… Tetratheca ci… Tetr… Elaeo… species   
#> 2 Peganum harmala         Peganum harmala  Peganum harm… Peganum harma… Pega… Nitra… species   
#> 3 Calotis multicaulis     Calotis multica… Calotis mult… Calotis multi… Calo… Aster… species   
#> 4 Leptospermum trinervium Leptospermum tr… Leptospermum… Leptospermum … Lept… Myrta… species   
#> 5 Lepidosperma laterale   Lepidosperma la… Lepidosperma… Lepidosperma … Lepi… Cyper… species   
#> 6 Enneapogon polyphyllus  Enneapogon poly… Enneapogon p… Enneapogon po… Enne… Poace… species   
#> # ℹ 123 more rows
#> # ℹ 14 more variables: taxonomic_dataset <chr>, taxonomic_status <chr>,
#> #   taxonomic_status_aligned <chr>, aligned_reason <chr>, update_reason <chr>, subclass <chr>,
#> #   taxon_distribution <chr>, scientific_name_authorship <chr>, taxon_ID <chr>,
#> #   taxon_ID_genus <chr>, scientific_name_ID <chr>, canonical_name <chr>, row_number <dbl>,
...
#>   original_name aligned_name  accepted_name suggested_name              genus family taxon_rank
#>   <chr>         <chr>         <chr>         <chr>                       <chr> <chr>  <chr>     
#> 1 Acacia aneura Acacia aneura Acacia aneura Acacia aneura [alternative… Acac… Fabac… species   
#> # ℹ 14 more variables: taxonomic_dataset <chr>, taxonomic_status <chr>,
#> #   taxonomic_status_aligned <chr>, aligned_reason <chr>, update_reason <chr>, subclass <chr>,
#> #   taxon_distribution <chr>, scientific_name_authorship <chr>, taxon_ID <chr>,
#> #   taxon_ID_genus <chr>, scientific_name_ID <chr>, canonical_name <chr>, row_number <dbl>,
...
#>   original_name aligned_name  accepted_name suggested_name              genus family taxon_rank
#>   <chr>         <chr>         <chr>         <chr>                       <chr> <chr>  <chr>     
#> 1 Acacia aneura Acacia aneura Acacia sp.    Acacia sp. [collapsed name… Acac… Fabac… species   
#> # ℹ 14 more variables: taxonomic_dataset <chr>, taxonomic_status <chr>,
#> #   taxonomic_status_aligned <chr>, aligned_reason <chr>, update_reason <chr>, subclass <chr>,
#> #   taxon_distribution <chr>, scientific_name_authorship <chr>, taxon_ID <chr>,
#> #   taxon_ID_genus <chr>, scientific_name_ID <chr>, canonical_name <chr>, row_number <dbl>,
